...
aggregate = table(closure,...
    ...
    'TotalLandRentPct','MeanCommuteTimePct_BaselineFlows',...
    'MeanCommuteTimePct_CounterfactualFlows','AggregateCommuterMinutesPct'});
...
aggregate.AggregateCommuterMinutesPct(...
    abs(aggregate.AggregateCommuterMinutesPct)<1e-10)=0;
aggregate.MeanCommuteTimePct_BaselineFlows(...
    abs(aggregate.MeanCommuteTimePct_BaselineFlows)<1e-10)=0;
aggregate.MeanCommuteTimePct_CounterfactualFlows(...
    abs(aggregate.MeanCommuteTimePct_CounterfactualFlows)<1e-10)=0;
end
