...
displayAggregate.Properties.VariableNames={...
    ...
    'ImmediateTimePct','PostMoveTimePct','TotalMinutesPct'};

fprintf(['\nAll entries are percentage changes relative to the pre-policy ',...
    'equilibrium; negative time changes mean time savings. ImmediateTimePct ',...
    'holds baseline commuting flows fixed; PostMoveTimePct uses scenario ',...
    'flows; TotalMinutesPct also includes the commuter-population change.\n']);
