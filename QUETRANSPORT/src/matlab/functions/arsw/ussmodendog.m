...
if (wage_e_r==wage_i_r) & (q_e_r==q_i_r) & (Q_e_r==Q_i_r) & (theta_e_r==theta_i_r) & (UU_e_r==UU_i_r);
    qt_progress_update('Open-city equilibrium',x,999,0,true);
...
qt_progress_update('Open-city equilibrium',x,999,maxLD,false);       % Compact, Spyder-safe convergence progress
...
if converge==0
    qt_progress_update('Open-city equilibrium',999,999,maxLD,false,true);
end
