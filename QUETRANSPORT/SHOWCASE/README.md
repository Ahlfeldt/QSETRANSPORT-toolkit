...
[AABPL toolkit](https://github.com/Ahlfeldt/AABPL-toolkit). Add a transport
scenario, edit the documented configuration file, and press **Run** to produce
the maps, tables, and diagnostics illustrated below.
