...
parameters, and solves closed- and open-city counterfactual equilibria. This
...
fundamentals;
\item solve the baseline and policy equilibria under the same closure and report
local, aggregate, welfare, and land-rent effects.
\end{enumerate}
...
\texttt{qt\_write\_closure\_results.m} & Reports local outcomes and annual land rent.\\
\bottomrule
\end{longtable}
